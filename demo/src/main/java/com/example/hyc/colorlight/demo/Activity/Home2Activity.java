...
import com.example.hyc.colorlight.demo.HomeFragment.LightAdapter;
...
public class Home2Activity extends AppCompatActivity{
    ...
    private static String TAG = "Home2Activity";
...
//        }
        ...
        ItemTouchHelper.SimpleCallback callback = new ItemTouchHelper.SimpleCallback(ItemTouchHelper.UP | ItemTouchHelper.DOWN | ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT,
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                final AlertDialog.Builder dialog = new AlertDialog.Builder(Home2Activity.this);
                dialog.setTitle("警告");
    ...
    private void deleteValue() {
        ...
        Toast.makeText(Home2Activity.this,"删除成功",Toast.LENGTH_SHORT).show();
        //====================================================//
    }
        ...
        switch (item.getItemId()) {
            case R.id.scan:
                ...
                * */
                ...
                Intent intent = new Intent(Home2Activity.this, CaptureActivity.class);
    ...
    private void updateHomeView(String new_light_name, String new_light_id)
    {
        if(new_light_name!=null&&new_light_id!=null)
        {
            ...
            Toast.makeText(Home2Activity.this,"添加成功",Toast.LENGTH_SHORT).show();
            //=====================================================//
    ...
    private void callSelfDialog(String id){
        selfDialog = new SelfDialog(Home2Activity.this,id,"确定",new SelfDialog.PriorityListener() {
            @Override
